...
async function performUAT(role, wallet, name) {
  ...
  try {
    ...
    // Get the set-cookie header from Login/Signup response loop
...
async function main() {
  ...
  const keystoreData = fs.readFileSync("/Users/adityashrivastava/Desktop/BLOCKCHAIN/secrets/eth-keystore.json", "utf8");
